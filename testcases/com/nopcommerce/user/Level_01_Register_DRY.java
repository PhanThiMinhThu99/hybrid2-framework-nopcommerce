...
public class Level_01_Register_DRY {
  ...
  driver.findElement(By.cssSelector("input#FirstName")).sendKeys("Minh");
  driver.findElement(By.cssSelector("input#LastName")).sendKeys("Thu");
  driver.findElement(By.cssSelector("input#Email")).sendKeys("minhthu" + generateFakeNumber() + "@gmail.com");
  driver.findElement(By.cssSelector("input#Password")).sendKeys("1236");
  driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("1236");
  driver.findElement(By.cssSelector("button#register-button")).click();
